...
export const IMAGE_QUIZ_QUESTIONS: ImageQuizQuestion[] = [
  ...
  {
    "id": "alexander-milosevic",
    "displayName": "Alexander Milosevic",
    "category": "persons",
    "contentSubject": "athlete",
    "correctYear": 1992,
    "audiences": [
  ...
  {
    "id": "kennedy-bakircioglu",
    "displayName": "Kennedy Bakircioglü",
    "category": "persons",
    "contentSubject": "athlete",
    "correctYear": 1980,
    "audiences": [
