...
const HINTS_LIBRARY_MANUAL: Record<string, HintLibrary> = {
  ...
  'rudolf-andersson': {
    ...
    hints: [
      ...
      h('t2',    'characteristic', 'Family',         'Part of the Andersson family in the "Sune" series',   3),
      h('sig',   'characteristic', 'Signature',      'Lovable Swedish dad figure in a beloved children\'s series',5),
    ],
  },
  ...
  'arvingarna': {
    ...
    hints: [
      ...
      h('sig',   'characteristic', 'Signature',     'Led by Claes Malmberg — one of Sweden\'s most popular dansband groups',5),
    ],
  },
  ...
  'friends': {
    ...
    hints: [
      h('prof',  'profession',     'Category',      'Swedish pop group',                                     1),
      h('bp',    'birth_place',    'Origin',        'Sweden',                                                 2),
      h('merit', 'merit',          'Achievement',   'Melodifestivalen participant',                          3),
  ...
  'afro-dite': {
    ...
    hints: [
      ...
      h('merit', 'merit',          'Achievement',   'Represented Sweden at Eurovision 2001',                 5),
  ...
  'the-mamas': {
    ...
    hints: [
      ...
      h('merit', 'merit',          'Achievement',   'Won Melodifestivalen 2020 — set to perform at Eurovision (cancelled COVID-19)',5),
  ...
  'brandsta-city-slackers': {
    ...
    hints: [
      ...
      h('bp',    'birth_place',    'Origin',        'Brandsta, Sweden',                                       2),
      h('merit', 'merit',          'Achievement',   'Competed in Melodifestivalen with humorous songs',      3),
      h('sig',   'characteristic', 'Signature',     'Comedy act that took Swedish Melodifestivalen by surprise',5),
    ],
  },
  ...
  'eldkvarn': {
    ...
    hints: [
      ...
      h('sig',   'characteristic', 'Signature',     'Pioneer of Swedish-language rock — influenced generations of Swedish musicians',5),
    ],
  },
