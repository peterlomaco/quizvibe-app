...
QuizVibe lanseras med en kampanjperiod där **Premium är gratis**. Store visar då kortet **"Single month — no auto-renewal"** med en **Free**-knapp, och **79 kr-kortet visas inte alls**. När Peter stänger kampanjen tar betal-kortet över.
